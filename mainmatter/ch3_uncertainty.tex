...
These methods will be illustrated in section~\ref{sec:Localization and mapping}
...
\gls{gls-Kalman-filter}. Section~\ref{sec:Cooperative localization} describes in more detailed how swarms of bots could
help each other in estimating their position.

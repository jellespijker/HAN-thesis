...
\gls{sym-p_k+1} is obtained by equation~\ref{eq:nextauvloc}. Where \( c \) is a positive constant and \gls{sym-m_n} is
...
describes how the sensor model can be used to build an on-line map of the environment where the \gls{Demspter-Shafer
theory} is used to filter out uncertainties of the sensor.

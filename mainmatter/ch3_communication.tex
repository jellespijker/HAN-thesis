...
Where \gls{sym-E_hat}  and \gls{sym-H_hat} are the amplitudes of the electric and the magnetic field wave and \gls{sym-gamma_EM} expressed in \gls{sym-epsilon_e}, as shown in equation~\ref{eq:propegationconst},

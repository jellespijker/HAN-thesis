...
From this list, only Project Chrono has an existing framework which takes into account soil dynamic behavior and
terramechanics. This is either simulated using \gls[first]{acr-DEM} or granular approach. Were each particle of sand is
...
An alternative method is the \gls[first]{acr-SCM}, based upon the familiar Becker-Wong model. The model provides a
...
of the material properties of the membrame and its ability to bounce back. The electrical components of these  sensors

...
% Describe why a simulation was needed instead of working on the real thing

\section{SIMULATION}\label{sec:simulation}
% Motivation for framework choice
...
It is important to evaluate the effects of control inputs $ \gls{s:u} $ \todo{explain control inputs} on the pose vector $ \gls{s:xk} $ such that $ \gls{s:xkt+1} $ can be predicted. Since the continuous-time model for the vehicle state's speed and rate can be described as:
...
\begin{itemize}
	...
	\item Size of the dredge bot.\footnotemark[\getrefnumber{c}]\footnotemark[\getrefnumber{used}]
	\item Weight of the dredge bot.\footnotemark[\getrefnumber{c}]\footnotemark[\getrefnumber{used}]
	\item Buoyancy of the dredge bot.\footnotemark[\getrefnumber{c}]\footnotemark[\getrefnumber{used}]
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \acrfull{SMW}\footnotemark[\getrefnumber{c}]\footnotemark[\getrefnumber{used}]
